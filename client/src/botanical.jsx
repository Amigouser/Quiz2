...
export const Leaf = ({ size = 64, style = {}, stroke = 1.2 }) => (
...
export const Fern = ({ size = 120, style = {}, stroke = 1 }) => (
...
export const Sprig = ({ size = 80, style = {}, stroke = 1 }) => (
...
export const Cell = ({ size = 120, style = {}, stroke = 1 }) => (
...
export const Helix = ({ size = 80, style = {}, stroke = 1 }) => (
...
export const PlatePlaceholder = ({ label = "Plantae — Ficus", style = {} }) => (
  <div style={{
    position: "relative",
...
export const BotanicalBg = ({ intensity = 1, pattern = "mix" }) => (
  <div style={{
...
export const LeafBurst = ({ count = 28, go = false }) => {
