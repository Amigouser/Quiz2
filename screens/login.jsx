// Login screen — 2 variants

const LoginClassic = ({ onEnter }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div className="eyebrow" style={{ marginBottom: 16 }}>Урок № 24 · 20 апреля</div>
          <h1 style={{
          ...
          <p style={{ color: "var(--text-soft)", fontSize: 17, maxWidth: 440, lineHeight: 1.6 }}>
            Сегодня изучаем строение растительной клетки, фотосинтез и немного — ботаническую классификацию. Готов?
          </p>
        </div>
    ...
    <div style={{
      ...
      <div className="card" style={{
        ...
        <form onSubmit={(e) => { e.preventDefault(); name.trim() && onEnter?.(name.trim()); }}
          ...
          <button type="submit" className="btn btn-primary btn-lg" disabled={!name.trim()}
            style={{ opacity: name.trim() ? 1 : 0.5, justifyContent: "center" }}>
            Продолжить 🌱
          </button>
        </form>
...
Object.assign(window, { LoginClassic, LoginCompact });
