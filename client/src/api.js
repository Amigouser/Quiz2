...
const API = {
  ...
  admin: {
    ...
    importTest: (data) => req("/api/admin/tests/import", { method: "POST", body: data }),
    ...
    duplicateTest: (id) => req(`/api/admin/tests/${id}/duplicate`, { method: "POST" }),
    ...
    duplicateCardSet: (id) => req(`/api/admin/flashcard-sets/${id}/duplicate`, { method: "POST" }),
